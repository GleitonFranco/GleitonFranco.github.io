...
var Paddle = {
  ...
  gradient: function() {
    ...
    // Closing paths can prevent buggy behavior such as graphic tears and vanishing objects. Used at a later time to configure movement.
...
var Ctrl = {
  ...
  stopTouchScroll: function(event) {
    event.preventDefault(); // se touch desabilita scroll
  },
